...
## Set the parameters
d1 = 0.277*5 # we got this number using half life? the half life of tryptophan is 2 hrs?
d2 = 1
d3 = 1
d4 = 1
d5 = 1
...
p1 = 1
p2 = 1
V1 = 400*0.01*0.8 # trying to get serotonin in gut 9 times serotonin in brain since 90% of serotonin synthesis is done in gut
V2 = 400
V3 = 400
V4 = 400
...
plot(sol[,1],sol[,2],type = 'l', lwd = 6, col = 'blue',
     ...
     main = 'Tryptophan in the Gut and Brain (Anx)')
...
plot(sol[,1],sol[,4],type = 'l', lwd = 6, col = 'blue',
     ...
     main = '5-HTP in the Gut and Brain (Anx)')
...
plot(sol[,1],sol[,6],type = 'l', lwd = 6, col = 'blue',
     ...
     main = 'Serotonin in the Gut and Brain (Anx)')
