...
food = function(t){
  ...
  D = 9
  tt = t %% 24
  food = ((tt>=7)&(tt<7.5))*L + ((tt>=2)&(tt<2.5))*S + ((tt>=7)&(tt<7.5))*D
...
plot(sol[,1],sol[,2],type = 'l', lwd = 6, col = 'blue',
     ...
     main = 'Tryptophan in the Gut and Brain (Fast)')
...
plot(sol[,1],sol[,4],type = 'l', lwd = 6, col = 'blue',
     ...
     main = '5-HTP in the Gut and Brain (Fast)')
...
plot(sol[,1],sol[,6],type = 'l', lwd = 6, col = 'blue',
     ...
     main = 'Serotonin in the Gut and Brain (Fast)')
