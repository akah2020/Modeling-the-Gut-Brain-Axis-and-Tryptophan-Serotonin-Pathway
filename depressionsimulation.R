...
## Set the parameters
d1 = 0.277*10 # we got this number using half life? the half life of tryptophan is 2 hrs?
# we multiplied this by 10 bc we think with depression, elimination would increase? 
d2 = 1
d3 = 1
d4 = 1
d5 = 1
...
plot(sol[,1],sol[,2],type = 'l', lwd = 6, col = 'blue',
     ...
     main = 'Tryptophan in the Gut and Brain (Dep)')
...
plot(sol[,1],sol[,4],type = 'l', lwd = 6, col = 'blue',
     ...
     main = '5-HTP in the Gut and Brain (Dep)')
...
plot(sol[,1],sol[,6],type = 'l', lwd = 6, col = 'blue',
     ...
     main = 'Serotonin in the Gut and Brain (Dep)')
